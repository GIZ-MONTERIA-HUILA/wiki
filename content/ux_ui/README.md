...
- Estructura general del diseño de pantallas
- Componentes reutilizables y estilos compartidos
- Flujos de navegación
- Interacciones principales del usuario

_El prototipo se mantiene actualizado como referencia maestra para el desarrollo front-end._
...
- Colores institucionales y secundarios
...
## 3. Wireframes Consolidados

Los **wireframes** presentan la **estructura funcional y jerarquía de información** de las pantallas clave del sistema antes del desarrollo visual final.

🔗 **<a href="https://drive.google.com/file/d/1aukhlAvbGEphcy6pRghtLfZ6wQ-2oo7i/view?usp=drive_link" target="_blank">Paleta de colores y fuentes SNIF Restauración (PDF)</a>**

### Contenido:

- Distribución general de la interfaz
- Flujos de navegación y jerarquías
- Elementos base (formularios, tablas, modales, menús)
- Referencias a componentes reutilizables en Figma

---

## 4. Lineamientos de Implementación UI/UX

Para la construcción de la interfaz, se deben seguir las siguientes **directrices de implementación**:

### Buenas prácticas recomendadas:

- Mantener la consistencia entre prototipos, maquetas y código implementado
- Utilizar variables centralizadas para colores y fuentes
- Asegurar compatibilidad con dispositivos móviles (**diseño responsive**)
- Aplicar principios de accesibilidad (contraste, tamaño mínimo de fuente, y etiquetas)
- Versionar los recursos gráficos y plantillas en un **repositorio controlado**
