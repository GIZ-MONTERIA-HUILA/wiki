...
> **Identificador Historia de Usuario:** hu-pigcct-sym-103 \
...
1. **Carga, Resumen y Confirmación**  
   ...
   1.3 Si el archivo pasa las validaciones (ver [HU-pigcct-sym-104](/content/historias_usuario/HU-pigcct-sym-104/HU-pigcct-sym-104.md)), el sistema debe mostrar un resumen antes de confirmar la carga, con los siguientes datos: Nombre del archivo, Número de polígonos detectados, Área total (ha), Proyección (EPSG), Tipo de geometría. \
...
![PROTOTIPO PRELIMINAR](assets/wireframe-hu-pigcct-sym-103.png)
